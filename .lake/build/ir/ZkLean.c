...
// Module: ZkLean
// Imports: Init ZkLean.AST ZkLean.Builder ZkLean.Formalism ZkLean.LookupTable ZkLean.Semantics
#include <lean/lean.h>
...
lean_object* initialize_ZkLean_Formalism(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_ZkLean(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_ZkLean_Formalism(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
