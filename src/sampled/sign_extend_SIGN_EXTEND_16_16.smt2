;; Auto-generated (FF, flat) from Lean subtable: SIGN_EXTEND_16_16
(set-logic ALL)
...
(define-fun poly_inputs () F (ff.mul fv1_0 (as ff65535 F)))
...
(assert (not (= bvoutput ((_ repeat 16) ((_ extract 7 7) bv1)) )))
