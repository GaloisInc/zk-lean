;; Auto-generated (FF, flat) from Lean subtable: EQ_ABS_16
(set-logic ALL)
...
(define-fun poly_inputs () F (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (as ff1 F) (ff.add (ff.mul fv1_1 fv2_1) (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_1)) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_1))))) (ff.add (ff.mul fv1_2 fv2_2) (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_2)) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_2))))) (ff.add (ff.mul fv1_3 fv2_3) (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_3)) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_3))))) (ff.add (ff.mul fv1_4 fv2_4) (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_4)) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_4))))) (ff.add (ff.mul fv1_5 fv2_5) (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_5)) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_5))))) (ff.add (ff.mul fv1_6 fv2_6) (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_6)) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_6))))) (ff.add (ff.mul fv1_7 fv2_7) (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_7)) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_7))))))
...
(assert (not (= bvoutput (ite (= (bvand bv1 #b01111111)
     (bvand bv2 #b01111111)) (_ bv1 8) (_ bv0 8)))))
