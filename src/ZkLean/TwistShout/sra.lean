...
def VirtualSRA_64 [Field f] : Subtable f 64 :=
  subtableFromMLE (fun x => (((((((((((((((((((((((((((((((0*(1 + x[1]) + x[0]*x[1])*(1 + x[3]) + x[2]*x[3])*(1 + x[5]) + x[4]*x[5])*(1 + x[7]) + x[6]*x[7])*(1 + x[9]) + x[8]*x[9])*(1 + x[11]) + x[10]*x[11])*(1 + x[13]) + x[12]*x[13])*(1 + x[15]) + x[14]*x[15])*(1 + x[17]) + x[16]*x[17])*(1 + x[19]) + x[18]*x[19])*(1 + x[21]) + x[20]*x[21])*(1 + x[23]) + x[22]*x[23])*(1 + x[25]) + x[24]*x[25])*(1 + x[27]) + x[26]*x[27])*(1 + x[29]) + x[28]*x[29])*(1 + x[31]) + x[30]*x[31])*(1 + x[33]) + x[32]*x[33])*(1 + x[35]) + x[34]*x[35])*(1 + x[37]) + x[36]*x[37])*(1 + x[39]) + x[38]*x[39])*(1 + x[41]) + x[40]*x[41])*(1 + x[43]) + x[42]*x[43])*(1 + x[45]) + x[44]*x[45])*(1 + x[47]) + x[46]*x[47])*(1 + x[49]) + x[48]*x[49])*(1 + x[51]) + x[50]*x[51])*(1 + x[53]) + x[52]*x[53])*(1 + x[55]) + x[54]*x[55])*(1 + x[57]) + x[56]*x[57])*(1 + x[59]) + x[58]*x[59])*(1 + x[61]) + x[60]*x[61])*(1 + x[63]) + x[62]*x[63] + x[0]*(0 + 2*(1 - x[3]) + 4*(1 - x[5]) + 8*(1 - x[7]) + 16*(1 - x[9]) + 32*(1 - x[11]) + 64*(1 - x[13]) + 128*(1 - x[15]) + 256*(1 - x[17]) + 512*(1 - x[19]) + 1024*(1 - x[21]) + 2048*(1 - x[23]) + 4096*(1 - x[25]) + 8192*(1 - x[27]) + 16384*(1 - x[29]) + 32768*(1 - x[31]) + 65536*(1 - x[33]) + 131072*(1 - x[35]) + 262144*(1 - x[37]) + 524288*(1 - x[39]) + 1048576*(1 - x[41]) + 2097152*(1 - x[43]) + 4194304*(1 - x[45]) + 8388608*(1 - x[47]) + 16777216*(1 - x[49]) + 33554432*(1 - x[51]) + 67108864*(1 - x[53]) + 134217728*(1 - x[55]) + 268435456*(1 - x[57]) + 536870912*(1 - x[59]) + 1073741824*(1 - x[61]) + 2147483648*(1 - x[63])))


lemma sra_32_mle_one_chunk_[ZKField f] (bv1 bv2 : BitVec 32) (fv1 fv2 : Vector f 32) :
  ...
  (bvoutput = (BitVec.sshiftRight bv1 bv2.toNat))
  =
  (foutput = evalSubtable VirtualSRA_64 (Vector.append fv1 fv2))
:= by
 solveMLE VirtualSRA_64 32
