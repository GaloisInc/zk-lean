...
def VirtualMovsign_32 [Field f] : Subtable f 64 :=
  subtableFromMLE (fun x => x[0]*4294967295)
...
lemma move_sign_32_mle_one_chunk_[ZKField f] (bv1 bv2 : BitVec 32) (fv1 fv2 : Vector f 32) :
  ...
  (bvoutput = (bv1.extractLsb 31 31).signExtend 32)
  =
  (foutput = evalSubtable VirtualMovsign_32 (Vector.append fv1 fv2))
:= by
 solveMLE VirtualMovsign_32 32
