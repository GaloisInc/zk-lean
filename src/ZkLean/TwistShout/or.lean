...
def OR_64 [Field f] : Subtable f 64 :=
  subtableFromMLE (fun x => 0 + 2147483648*(x[0] + x[1] - x[0]*x[1]) + 1073741824*(x[2] + x[3] - x[2]*x[3]) + 536870912*(x[4] + x[5] - x[4]*x[5]) + 268435456*(x[6] + x[7] - x[6]*x[7]) + 134217728*(x[8] + x[9] - x[8]*x[9]) + 67108864*(x[10] + x[11] - x[10]*x[11]) + 33554432*(x[12] + x[13] - x[12]*x[13]) + 16777216*(x[14] + x[15] - x[14]*x[15]) + 8388608*(x[16] + x[17] - x[16]*x[17]) + 4194304*(x[18] + x[19] - x[18]*x[19]) + 2097152*(x[20] + x[21] - x[20]*x[21]) + 1048576*(x[22] + x[23] - x[22]*x[23]) + 524288*(x[24] + x[25] - x[24]*x[25]) + 262144*(x[26] + x[27] - x[26]*x[27]) + 131072*(x[28] + x[29] - x[28]*x[29]) + 65536*(x[30] + x[31] - x[30]*x[31]) + 32768*(x[32] + x[33] - x[32]*x[33]) + 16384*(x[34] + x[35] - x[34]*x[35]) + 8192*(x[36] + x[37] - x[36]*x[37]) + 4096*(x[38] + x[39] - x[38]*x[39]) + 2048*(x[40] + x[41] - x[40]*x[41]) + 1024*(x[42] + x[43] - x[42]*x[43]) + 512*(x[44] + x[45] - x[44]*x[45]) + 256*(x[46] + x[47] - x[46]*x[47]) + 128*(x[48] + x[49] - x[48]*x[49]) + 64*(x[50] + x[51] - x[50]*x[51]) + 32*(x[52] + x[53] - x[52]*x[53]) + 16*(x[54] + x[55] - x[54]*x[55]) + 8*(x[56] + x[57] - x[56]*x[57]) + 4*(x[58] + x[59] - x[58]*x[59]) + 2*(x[60] + x[61] - x[60]*x[61]) + 1*(x[62] + x[63] - x[62]*x[63]))

lemma or_mle_one_chunk_[ZKField f] (bv1 bv2 : BitVec 32) (fv1 fv2 : Vector f 32) :
